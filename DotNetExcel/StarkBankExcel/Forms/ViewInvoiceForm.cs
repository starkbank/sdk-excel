...
namespace StarkBankExcel.Forms
{
    public partial class ViewInvoiceForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            worksheet.Range["Q" + TableFormat.HeaderRow].Value = "Split";
            worksheet.Range["R" + TableFormat.HeaderRow].Value = "Split 1";
            worksheet.Range["S" + TableFormat.HeaderRow].Value = "Split 2";
            worksheet.Range["T" + TableFormat.HeaderRow].Value = "Split 3";
